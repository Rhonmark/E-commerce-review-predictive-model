...
class SentimentAnalysisApp:
    ...
    def create_widgets(self):
        ...
        self.mc_sims = ttk.Spinbox(options_frame, from_=100, to=5000, increment=100, width=10)
        ...
        self.test_size = ttk.Spinbox(options_frame, from_=0.1, to=0.5, increment=0.05, width=10)
        self.test_size.set(0.2)
        self.test_size.grid(row=0, column=3, padx=5, pady=5, sticky=tk.W)
    ...
    def perform_analysis(self):
        try:
            ...
            self.run_monte_carlo(simulations, x_test, y_test)
    ...
    def run_monte_carlo(self, simulations, x_test, y_test):
        ...
        for i in range(min(10, len(mc_results))):
    ...
    def create_mc_plot(self):
        ...
        ax.set_title('Monte Carlo Logistic Regression Results with Uncertainty')
        cbar = fig.colorbar(scatter, ax=ax)
